...
<div class="customer-links"><a class="customer-link customer-link--primary" href="<?= url('catalog') ?>">Browse parts</a></div></div>
...
<article><h2>Fast Delivery</h2><p>Prompt dispatch and reliable delivery directly to your garage or doorstep.</p><a href="<?= url('catalog') ?>">Start shopping</a></article>
</section></div>
