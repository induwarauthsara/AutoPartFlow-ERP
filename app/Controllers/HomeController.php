        ...
        try {
            ...
            if ($e instanceof \PDOException) {
                ...
                if ($sqlState === '23000') {
                    ...
                    $message = 'Registration cannot start because a required database table is missing.';
                } elseif ($sqlState === '42S22') {
                    $message = 'Registration cannot start because the database structure is older than this project version.';
                } else {
                    $message = 'We could not create the account: ' . $e->getMessage();
                }
            } else {
                $message = 'We could not create the account: ' . $e->getMessage();
            }
