<main class="sales-main customers-main" data-sales-page="customers" data-orders-url="<?= url('sales/orders') ?>">
    ...
    <div class="customer-workspace">
        <section class="customer-master sales-card">
            <div class="customer-filters" id="customer-filters">
                <button class="sales-filter sales-filter--active" type="button" data-customer-filter="all">All Customers</button>
                <button class="sales-filter" type="button" data-customer-filter="overdue">Overdue Balance</button>
                <button class="sales-filter" type="button" data-customer-filter="high-volume">High Volume</button>
            </div>
            <div class="customer-list" id="customer-list"></div>
            <p class="sales-empty hidden" id="customer-empty">No customers match your search.<span class="sales-empty__action">Try another name or switch tabs.</span></p>
        </section>

        <section class="customer-detail" id="customer-detail" aria-label="Selected customer profile"></section>
    </div>

    <dialog class="customer-dialog sales-dialog" id="customer-dialog">
