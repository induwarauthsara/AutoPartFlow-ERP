...
<a class="nav-link" href="<?= url('admin/settings') ?>"><svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 5h18v2H3V5Zm4 6h10v2H7v-2Zm3 6h4v2h-4v-2Z"/></svg>Settings</a>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="card">
                <h3 style="margin-top:0;">Personnel Directory <span style="font-size:12px;font-weight:500;color:var(--slate-500);">(<?= count($employees) ?>)</span></h3>
                ...
                <table>
                    ...
                    <?php endforeach; ?>
                    <?php if (!$employees): ?><tr><td colspan="6">No employees yet. Add your first employee with "+ New Employee".</td></tr><?php endif; ?>
                    </tbody>
                </table>
                </div>
            </div>
